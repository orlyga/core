 ...
 */
Configure::write('Security.salt', '3520f5cf86239dd715c2d81785d164f8165af5b2');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
Configure::write('Security.cipherSeed', '10257521302109730938');
...
//orly added control of core in multisite
if (file_exists(WWW_ROOT . 'Config' . DS . 'core.php')) {
	require WWW_ROOT . 'Config' . DS . 'core.php';
	}