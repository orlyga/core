	...
	echo '<tr><td>';
		...
		echo '</td><td><table style="border:0;"><tr><td>';
				 echo $this->Form->input("item_code",array("name"=>'data[Photo]['.$i.'][item_code]'));
					...
					echo '</td></tr><tr><td>';	
							echo $this->Form->input("term1",array("name"=>'data[Photo]['.$i.'][term1]'));
					echo '</td></tr><tr><td>';
						echo $this->Form->input("term2",array("name"=>'data[Photo]['.$i.'][term2]'));
					echo '</td></tr><tr><td>';
						echo $this->Form->input("term3",array("name"=>'data[Photo]['.$i.'][term3]'));
			echo '</td></tr></table></td>';	
			echo '<td width="300px">'	;
