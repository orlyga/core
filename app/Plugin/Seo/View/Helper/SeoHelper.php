 ...
 */
    public function beforeRender() {
	        ...
	        if(isset($this->request->params['ext']) && ($this->request->params['ext'] == '' && $this->request->params['ext'] == 'html') && strlen(Configure::read('Seo.add_copy_link'))>0){    
	        	//grab the google analytics element and splice in changes
 ...
 */
    ...
    public function isTitleSet(){
    	return ((isset($this->Layout->View->viewVars['node']['Seo']['meta_title']))&& ($this->Layout->View->viewVars['node']['Seo']['meta_title']<>"") );
    }
}
?>